...
function saveTeam(team, league_id, team_info, stats, home_stats, away_stats){
	team.set({
		...
		home_wins_plus_2: home_stats.home_wins_plus_2,
		home_wins_plus_3: home_stats.home_wins_plus_3,
		home_wins_minus_5: home_stats.home_wins_minus_5,
		...
		away_wins_plus_2: away_stats.away_wins_plus_2,
		away_wins_plus_3: away_stats.away_wins_plus_3,
		away_wins_minus_5: away_stats.away_wins_minus_5,
